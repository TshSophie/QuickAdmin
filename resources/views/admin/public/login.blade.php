...
<head>
    ...
    <![endif]-->
    <title>麦田优文后台</title>
    <meta name="keywords" content="麦田优文编程客栈，做优质的开发博客">
    <meta name="description" content="记录编程路上的点点滴滴！">
</head>
<body>
    ...
    <div id="loginform" class="loginBox">
        ...
        <form class="form form-horizontal" action="/admin/public/check" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
                        <input type="checkbox" name="online" id="online" value="1" dirname="">
                        使我保持登录状态</label>
                </div>
            </div>
            {{csrf_field()}}
...
<div class="footer">Copyright 麦田优文</div>
...
<script type="text/javascript">
    ...
    @if (count($errors) > 0)
            ...
            layer.alert(MsgArr,{title:'错误提示',icon:5})
